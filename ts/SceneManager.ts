...
// Type declaration for global GSAP
...
export class SceneManager {
  ...
  public envMapTexture: THREE.Texture | null = null;
  public currentModelRoot: THREE.Group | null = null;
  public activeSkeletonProxy: THREE.Group | null = null;
  public resizeObserver: ResizeObserver | null = null;

  public autoRotateActive: boolean = false;
  public autoRotateSpeed: number = 1.5;
  ...
  private initControls(): void {
    const threeScope: any = typeof window !== "undefined" && (window as any).THREE ? (window as any).THREE : THREE;
   ...
   */
  public mountSkeletonProxy(skeletonGroup: THREE.Group): void {
   ...
   */
  public async transitionFromSkeleton(fullModelGroup: THREE.Group, duration: number = 0.5): Promise<void> {
   ...
   */
  public setModel(newModelGroup: THREE.Group): void {
    if (this.activeSkeletonProxy) {
      this.disposeHierarchy(this.activeSkeletonProxy);
      this.scene.remove(this.activeSkeletonProxy);
      this.activeSkeletonProxy = null;
   ...
   */
  public disposeHierarchy(node: THREE.Object3D | null): void {
    if (!node) return;
    node.traverse((child) => {
  ...
  public disposeMaterial(mat: THREE.Material | null): void {
    if (!mat) return;
    Object.keys(mat).forEach((prop) => {
      const p = (mat as any)[prop];
  ...
  public toggleAutoRotate(active: boolean, speed: number = 1.5): void {
