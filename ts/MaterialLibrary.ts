...
export class MaterialLibrary implements IMaterialLibrary {
  public currentMainColor: string = "#F4F4F4"; // RAL 9003 Signal White
  public currentAccentColor: string = "#979A9C"; // RAL 7036 Platinum Grey
  public currentBlueColor: string = "#00529B"; // UltraFab Signature Blue / RAL 5010
  public wireframeActive: boolean = false;

  public epoxyBumpMap!: THREE.CanvasTexture;
  public metalRoughnessMap!: THREE.CanvasTexture;

  public mainMat!: THREE.MeshStandardMaterial;
  public grayAccentMat!: THREE.MeshStandardMaterial;
  public blueAccentMat!: THREE.MeshStandardMaterial;
  public blackWorktopMat!: THREE.MeshStandardMaterial;
  public stainlessMat!: THREE.MeshStandardMaterial;
  public glassCabinetMat!: THREE.MeshPhysicalMaterial;
  public polypropyleneMat!: THREE.MeshStandardMaterial;
  public blackEpoxySinkMat!: THREE.MeshStandardMaterial;
  public waterValveMat!: THREE.MeshStandardMaterial;
  public gasValveMat!: THREE.MeshStandardMaterial;
  public vacuumValveMat!: THREE.MeshStandardMaterial;
  public socketPlateMat!: THREE.MeshStandardMaterial;
  public socketRockerMat!: THREE.MeshStandardMaterial;
  public ovenBodyMat!: THREE.MeshStandardMaterial;
  public ovenCharcoalMat!: THREE.MeshStandardMaterial;
  public roomWallMat!: THREE.MeshStandardMaterial;
  public roomFloorMat!: THREE.MeshStandardMaterial;
  public wireframeMat!: THREE.MeshBasicMaterial;
   ...
   */
  public setColors(mainHex: string, accentHex: string, blueHex: string | null = null): void {
    this.currentMainColor = mainHex;
    this.currentAccentColor = accentHex;
    if (blueHex) this.currentBlueColor = blueHex;

    this.mainMat.color.set(this.currentMainColor);
    this.grayAccentMat.color.set(this.currentAccentColor);
    if (blueHex) this.blueAccentMat.color.set(this.currentBlueColor);
  }

  /**
   * Toggle Wireframe Mode for entire scene hierarchy
   */
  public toggleWireframe(root: THREE.Object3D | null, active: boolean): void {
        ...
        if (mesh.material) {
          if (Array.isArray(mesh.material)) {
            mesh.material.forEach((m) => {
              if (m && "wireframe" in m) {
                (m as any).wireframe = active;
              }
            });
          } else {
            if (mesh.material && "wireframe" in mesh.material) {
              (mesh.material as any).wireframe = active;
            }
          }
        }
      }
   ...
   */
  public dispose(): void {
    if (this.epoxyBumpMap) this.epoxyBumpMap.dispose();
    if (this.metalRoughnessMap) this.metalRoughnessMap.dispose();
