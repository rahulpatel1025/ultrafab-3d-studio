...
export class ModelGenerators {
    ...
    buildLShapedWorkstationScene() {
        ...
        const winFrame = new THREE.Mesh(createRoundedBoxGeometry(1.6, 1.4, 0.04, 0.008, 2), this.materials.mainMat);
        winGroup.add(winFrame);
        const winGlass = new THREE.Mesh(new THREE.PlaneGeometry(1.44, 1.24), new THREE.MeshBasicMaterial({ color: 0x93c5fd, transparent: true, opacity: 0.65 }));
